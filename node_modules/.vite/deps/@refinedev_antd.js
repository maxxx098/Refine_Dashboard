...
import "./chunk-LEILMFC2.js";
import {
  __assign
} from "./chunk-H4R2UIYM.js";
import {
  require_dayjs_min
    ...
    function tokensToFunction(tokens) {
      ...
      return function(data, options) {
        ...
        for (var i2 = 0; i2 < tokens.length; i2++) {
          ...
          if (token2.optional) {
            if (token2.partial) path += token2.prefix;
            continue;
          }
...
var ro = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  ...
  }, [C, g, x, L]), import_react75.default.useEffect(() => {
    var R;
  ...
  let q = { disabled: D, loading: D, onClick: () => {
    P.submit();
  } }, k = (0, import_react75.useCallback)(() => {
    if (S2.status === "success" && (n2 != null && n2.invalidateOnClose) && y({ id: B, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: d }), U) if (window.confirm(H("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) j(false);
    else return;
    L == null || L(void 0), w.close();
  }, [U, S2.status]), O = (0, import_react75.useCallback)((R) => {
...
var no = o2(({ syncWithLocation: e2, defaultVisible: t = false, autoSubmitClose: r = true, autoResetForm: s = true, autoSave: n2, invalidates: i, ...a }) => {
  ...
  }, [P, b, v, S2, u]), import_react76.default.useEffect(() => {
    var k;
  ...
  let j = $(), { warnWhen: h, setWarnWhen: K } = vt(), $2 = { disabled: D, onClick: () => {
    ...
    S2 == null || S2(void 0), d();
  } }, w = (0, import_react76.useCallback)(() => {
    if (U.status === "success" && (n2 != null && n2.invalidateOnClose) && l({ id: c, invalidates: i || ["list", "many", "detail"], dataProviderName: a.dataProviderName, resource: m }), h) if (window.confirm(j("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes."))) K(false);
    else return;
    d(), S2 == null || S2(void 0);
  }, [h]), q = (0, import_react76.useCallback)((k) => {
...
var Fe = o2(({ to: e2, element: t }) => {
  ...
  return import_react78.default.createElement(s === "legacy" ? r : n2, { to: e2, replace: false, onClick: (a) => {
    a.preventDefault();
  } }, t);
}, "PaginationLink");
var Tt = o2(({ onSearch: e2, initialCurrent: t, initialPageSize: r, hasPagination: s = true, pagination: n2, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, defaultSetFilterBehavior: y, filters: p, sorters: f, syncWithLocation: d, resource: g, successNotification: T, errorNotification: m, queryOptions: b, liveMode: x, onLiveEvent: C, liveParams: v, meta: P, metaData: F, dataProviderName: B } = {}) => {
  ...
  let ee = o2((de, te, me) => {
    ...
    if (te === "page") return (0, import_react77.createElement)(Fe, { to: ce, element: `${de}` });
    if (te === "next" || te === "prev") return (0, import_react77.createElement)(Fe, { to: ce, element: me });
    if (te === "jump-next" || te === "jump-prev") {
      let ge2 = (ne = me == null ? void 0 : me.props) == null ? void 0 : ne.children;
      return (0, import_react77.createElement)(Fe, { to: ce, element: import_react77.Children.count(ge2) > 1 ? (0, import_react77.createElement)(import_react77.Fragment, {}, ge2) : ge2 });
    }
    return me;
...
var Cm = o2(({ resource: e2, resourceName: t, mapData: r = o2((p) => p, "mapData"), paparseOptions: s, batchSize: n2 = Number.MAX_SAFE_INTEGER, onFinish: i, meta: a, metaData: l, dataProviderName: u, onProgress: y } = {}) => {
  let p = $(), { resource: f } = Y(e2 ?? t), { mutationResult: d, isLoading: g, handleChange: T } = Yh({ resource: (f == null ? void 0 : f.identifier) ?? (f == null ? void 0 : f.name), mapData: r, paparseOptions: s, batchSize: n2, meta: S(a, l), metaData: S(a, l), dataProviderName: u, onFinish: i, onProgress: y ?? (({ totalAmount: m, processedAmount: b }) => {
    if (m > 0 && b > 0) {
      let x = import_react79.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react79.default.createElement(progress_default, { type: "circle", percent: Math.floor(b / m * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react79.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, p("notifications.importProgress", { processed: b, total: m }, `Importing: ${b}/${m}`)));
...
var ns = o2(({ resource: e2, initialCurrent: t, initialPageSize: r, pagination: s, hasPagination: n2 = true, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, defaultSetFilterBehavior: y, filters: p, sorters: f, onSearch: d, queryOptions: g, syncWithLocation: T, successNotification: m, errorNotification: b, liveMode: x, onLiveEvent: C, liveParams: v, meta: P, metaData: F, dataProviderName: B } = {}) => {
  let { sorters: L, sorter: D, filters: c, current: S2, pageSize: H, pageCount: U, setFilters: j, setCurrent: h, setPageSize: K, setSorter: $2, setSorters: A, createLinkForSyncWithLocation: w, tableQueryResult: q, tableQuery: k, overtime: O } = dC({ resource: e2, initialSorter: i, permanentSorter: a, initialFilter: l, permanentFilter: u, filters: p, sorters: f, defaultSetFilterBehavior: y, initialCurrent: t, initialPageSize: r, queryOptions: g, successNotification: m, errorNotification: b, liveMode: x, onLiveEvent: C, liveParams: v, meta: S(P, F), metaData: S(P, F), syncWithLocation: T, dataProviderName: B, pagination: s, hasPagination: n2 }), M = n2 === false ? "off" : "server", Y2 = ((s == null ? void 0 : s.mode) ?? M) !== "off", N = grid_default.useBreakpoint(), z = Zs(x), [E] = form_default.useForm(), { data: R, isFetched: J, isLoading: X } = q, se2 = o2((Z, ee) => {
    ...
    if (ee === "page") return (0, import_react80.createElement)(Fe, { to: ie2, element: `${Z}` });
    if (ee === "next" || ee === "prev") return (0, import_react80.createElement)(Fe, { to: ie2, element: le2 });
    if (ee === "jump-next" || ee === "jump-prev") {
      let te = (de = le2 == null ? void 0 : le2.props) == null ? void 0 : de.children;
      return (0, import_react80.createElement)(Fe, { to: ie2, element: import_react80.Children.count(te) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, te) : te });
    }
    return le2;
...
var Am = o2(() => {
  let [e2, t] = (0, import_react81.useState)(false), r = (0, import_react81.useCallback)((s) => {
    ls(s.fileList).includes(true) ? t(true) : t(false);
  }, []);
  return (0, import_react81.useMemo)(() => ({ isLoading: e2, onChange: r }), [e2]);
}, "useFileUploadState");
...
var Ue = import_react83.default.createContext({ siderCollapsed: false, mobileSiderOpen: false, setSiderCollapsed: () => {
}, setMobileSiderOpen: () => {
} });
var ht = o2(({ children: e2, initialSiderCollapsed: t }) => {
  let [r, s] = (0, import_react83.useState)(t ?? false), [n2, i] = (0, import_react83.useState)(false);
  return import_react83.default.createElement(Ue.Provider, { value: { siderCollapsed: r, mobileSiderOpen: n2, setSiderCollapsed: s, setMobileSiderOpen: i } }, e2);
}, "ThemedLayoutContextProvider");
var qm = o2(() => {
  let { mobileSiderOpen: e2, siderCollapsed: t, setMobileSiderOpen: r, setSiderCollapsed: s } = (0, import_react82.useContext)(Ue);
...
var xt = o2(({ message: e2, cancelMutation: t, undoableTimeout: r }) => import_react86.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react86.default.createElement(progress_default, { type: "circle", percent: (r ?? 0) * 20, format: (s) => s && s / 20, size: 50, strokeColor: "#1890ff", status: "normal" }), import_react86.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, e2), import_react86.default.createElement(button_default, { style: { flexShrink: 0 }, onClick: t, disabled: r === 0, icon: import_react86.default.createElement(UndoOutlined_default, null) })), "UndoableNotification");
var ac = { open: ({ key: e2, message: t, description: r, type: s, cancelMutation: n2, undoableTimeout: i }) => {
  s === "progress" ? notification_default.open({ key: e2, description: import_react85.default.createElement(xt, { notificationKey: e2, message: t, cancelMutation: () => {
    n2 == null || n2(), notification_default.destroy(e2 ?? "");
  }, undoableTimeout: i }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : notification_default.open({ key: e2, description: t, message: r ?? null, type: s });
...
var ic = o2(() => {
  ...
  return { open: ({ key: s, message: n2, description: i, type: a, cancelMutation: l, undoableTimeout: u }) => {
    a === "progress" ? t.open({ key: s, description: import_react85.default.createElement(xt, { notificationKey: s, message: n2, cancelMutation: () => {
      l == null || l(), t.destroy(s ?? "");
    }, undoableTimeout: u }), message: null, duration: 0, closeIcon: import_react85.default.createElement(import_react85.default.Fragment, null) }) : t.open({ key: s, description: n2, message: i ?? null, type: a });
  }, close: (s) => t.destroy(s) };
...
var Ct = o2(({ Title: e2, render: t, meta: r }) => {
  let [s, n2] = (0, import_react88.useState)(false), [i, a] = (0, import_react88.useState)(false), l = mo(), u = se(), y = yt(), { warnWhen: p, setWarnWhen: f } = vt(), { Link: d } = le(), g = u === "legacy" ? d : y, T = da(), m = $(), { menuItems: b, selectedKey: x, defaultOpenKeys: C } = Qu({ meta: r }), v = grid_default.useBreakpoint(), { hasDashboard: P } = ge(), F = ie(), { mutate: B } = Lr({ v3LegacyAuthProviderCompatible: !!(F != null && F.isLegacy) }), L = typeof v.lg > "u" ? false : !v.lg, D = e2 ?? T ?? Ft, c = o2((w, q) => w.map((k) => {
    let { icon: O, label: M, route: Y2, key: N, name: z, children: E, parentName: R, meta: J, options: X } = k;
    if (E.length > 0) return import_react88.default.createElement(xc, { key: k.key, resource: z, action: "list", params: { resource: k } }, import_react88.default.createElement(menu_default.SubMenu, { key: k.key, icon: O ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: M }, c(E, q)));
    let se2 = N === q, _ = !(S(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && E.length === 0);
    return import_react88.default.createElement(xc, { key: k.key, resource: z, action: "list", params: { resource: k } }, import_react88.default.createElement(menu_default.Item, { key: k.key, style: { fontWeight: se2 ? "bold" : "normal" }, icon: O ?? (_ && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(g, { to: Y2 ?? "" }, M), !s && se2 && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  ...
  }, "handleLogout"), H = l && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: S2, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, m("buttons.logout", "Logout")), U = P ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: x === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(g, { to: "/" }, m("dashboard.title", "Dashboard")), !s && x === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, j = c(b, x), h = o2(() => t ? t({ dashboard: U, items: j, logout: H, collapsed: s }) : import_react88.default.createElement(import_react88.default.Fragment, null, U, j, H), "renderSider"), K = o2(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: x ? [x] : [], defaultOpenKeys: C, mode: "inline", onClick: () => {
    a(false), v.lg || n2(true);
  } }, h())), "renderMenu"), $2 = o2(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: i, onClose: () => a(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(D, { collapsed: false }), K()))), import_react88.default.createElement(button_default, { style: go, size: "large", onClick: () => a(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return import_react88.default.createElement(config_provider_default, { theme: { components: { Menu: { colorItemBg: "transparent", colorItemText: "#fff", colorItemTextSelected: "#fff", colorItemBgSelected: "transparent", colorItemTextHover: "#fff" } } } }, o2(() => L ? $2() : import_react88.default.createElement(layout_default.Sider, { collapsible: true, collapsed: s, onCollapse: (w) => n2(w), collapsedWidth: 80, breakpoint: "lg" }, import_react88.default.createElement(D, { collapsed: s }), K()), "renderContent")());
}, "Sider");
var Bt = o2(() => {
  let e2 = ie(), { data: t } = oo({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
  return t && (t.name || t.avatar) ? import_react89.default.createElement(layout_default.Header, { style: { display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react89.default.createElement(space_default, { style: { marginLeft: "8px" } }, (t == null ? void 0 : t.name) && import_react89.default.createElement(typography_default.Text, { style: { color: "white" }, strong: true }, t.name), (t == null ? void 0 : t.avatar) && import_react89.default.createElement(avatar_default, { src: t == null ? void 0 : t.avatar, alt: t == null ? void 0 : t.name }))) : null;
}, "Header");
var zs = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  ...
  return import_react87.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react87.default.createElement(l, { Title: s }), import_react87.default.createElement(layout_default, null, import_react87.default.createElement(u, null), import_react87.default.createElement(layout_default.Content, null, import_react87.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), i && import_react87.default.createElement(i, null)), n2 && import_react87.default.createElement(n2, null)));
}, "Layout");
var Ft = o2(({ collapsed: e2 }) => {
  let t = se(), r = yt(), { Link: s } = le();
  return import_react90.default.createElement(t === "legacy" ? s : r, { to: "/" }, e2 ? import_react90.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center" } }, import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine-mini.svg", alt: "Refine", style: { margin: "0 auto", padding: "12px 0", maxHeight: "65.5px" } })) : import_react90.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine", style: { width: "200px", padding: "12px 24px" } }));
}, "Title");
var xo = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Lt = o2(({ Title: e2, render: t, meta: r }) => {
  let { token: s } = theme_default.useToken(), [n2, i] = (0, import_react92.useState)(false), [a, l] = (0, import_react92.useState)(false), u = mo(), y = se(), p = yt(), { warnWhen: f, setWarnWhen: d } = vt(), { Link: g } = le(), T = y === "legacy" ? g : p, m = da(), b = $(), { menuItems: x, selectedKey: C, defaultOpenKeys: v } = Qu({ meta: r }), P = grid_default.useBreakpoint(), { hasDashboard: F } = ge(), B = ie(), { mutate: L } = Lr({ v3LegacyAuthProviderCompatible: !!(B != null && B.isLegacy) }), D = typeof P.lg > "u" ? false : !P.lg, c = e2 ?? m ?? kt, S2 = o2((w, q) => w.map((k) => {
    let { icon: O, label: M, route: Y2, key: N, name: z, children: E, parentName: R, meta: J, options: X } = k;
    if (E.length > 0) return import_react92.default.createElement(xc, { key: k.key, resource: z, action: "list", params: { resource: k } }, import_react92.default.createElement(menu_default.SubMenu, { key: k.key, icon: O ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: M }, S2(E, q)));
    let se2 = N === q, _ = !(S(J == null ? void 0 : J.parent, X == null ? void 0 : X.parent, R) !== void 0 && E.length === 0);
    return import_react92.default.createElement(xc, { key: k.key, resource: z, action: "list", params: { resource: k } }, import_react92.default.createElement(menu_default.Item, { key: k.key, icon: O ?? (_ && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(T, { to: Y2 ?? "" }, M), !n2 && se2 && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), H = o2(() => {
    f ? window.confirm(b("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (d(false), L()) : L();
  }, "handleLogout"), U = u && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => H(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, b("buttons.logout", "Logout")), j = F ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(T, { to: "/" }, b("dashboard.title", "Dashboard")), !n2 && C === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, h = S2(x, C), K = o2(() => t ? t({ dashboard: j, items: h, logout: U, collapsed: n2 }) : import_react92.default.createElement(import_react92.default.Fragment, null, j, h, U), "renderSider"), $2 = o2(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: C ? [C] : [], defaultOpenKeys: v, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    l(false), P.lg || i(true);
  } }, K())), "renderMenu"), A = o2(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: a, onClose: () => l(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated } }, import_react92.default.createElement(c, { collapsed: false })), $2()))), import_react92.default.createElement(button_default, { style: xo, size: "large", onClick: () => l(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  return D ? A() : import_react92.default.createElement(layout_default.Sider, { style: { backgroundColor: s.colorBgContainer, borderRight: `1px solid ${s.colorBgElevated}` }, collapsible: true, collapsed: n2, onCollapse: (w) => i(w), collapsedWidth: 80, breakpoint: "lg", trigger: import_react92.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: s.colorBgElevated } }, n2 ? import_react92.default.createElement(RightOutlined_default, { style: { color: s.colorPrimary } }) : import_react92.default.createElement(LeftOutlined_default, { style: { color: s.colorPrimary } })) }, import_react92.default.createElement("div", { style: { width: n2 ? "80px" : "200px", padding: n2 ? "0" : "0 16px", display: "flex", justifyContent: n2 ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: s.colorBgElevated, fontSize: "14px" } }, import_react92.default.createElement(c, { collapsed: n2 })), $2());
}, "ThemedSider");
var Dt = o2(() => {
  let { token: e2 } = theme_default.useToken(), t = ie(), { data: r } = oo({ v3LegacyAuthProviderCompatible: !!(t != null && t.isLegacy) });
  return r && (r.name || r.avatar) ? import_react93.default.createElement(layout_default.Header, { style: { backgroundColor: e2.colorBgElevated, display: "flex", justifyContent: "flex-end", alignItems: "center", padding: "0px 24px", height: "64px" } }, import_react93.default.createElement(space_default, null, import_react93.default.createElement(space_default, { size: "middle" }, (r == null ? void 0 : r.name) && import_react93.default.createElement(typography_default.Text, { strong: true }, r.name), (r == null ? void 0 : r.avatar) && import_react93.default.createElement(avatar_default, { src: r == null ? void 0 : r.avatar, alt: r == null ? void 0 : r.name })))) : null;
}, "ThemedHeader");
var xn = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i }) => {
  ...
  return import_react91.default.createElement(layout_default, { style: { minHeight: "100vh" } }, import_react91.default.createElement(l, { Title: s }), import_react91.default.createElement(layout_default, null, import_react91.default.createElement(u, null), import_react91.default.createElement(layout_default.Content, null, import_react91.default.createElement("div", { style: { minHeight: 360, padding: y ? 24 : 12 } }, e2), i && import_react91.default.createElement(i, null)), n2 && import_react91.default.createElement(n2, null)));
}, "ThemedLayout");
var Ln = "Refine Project";
var kn = import_react94.default.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react94.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.7889 0.422291C12.6627 -0.140764 11.3373 -0.140764 10.2111 0.422291L2.21115 4.42229C0.85601 5.09986 0 6.48491 0 8V16C0 17.5151 0.85601 18.9001 2.21115 19.5777L10.2111 23.5777C11.3373 24.1408 12.6627 24.1408 13.7889 23.5777L21.7889 19.5777C23.144 18.9001 24 17.5151 24 16V8C24 6.48491 23.144 5.09986 21.7889 4.42229L13.7889 0.422291ZM8 8C8 5.79086 9.79086 4 12 4C14.2091 4 16 5.79086 16 8V16C16 18.2091 14.2091 20 12 20C9.79086 20 8 18.2091 8 16V8Z", fill: "currentColor" }), import_react94.default.createElement("path", { d: "M14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8Z", fill: "currentColor" }));
var kt = o2(({ collapsed: e2, icon: t = kn, text: r = Ln, wrapperStyles: s }) => {
  let { token: n2 } = theme_default.useToken(), i = se(), a = yt(), { Link: l } = le();
  return import_react94.default.createElement(i === "legacy" ? l : a, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react94.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react94.default.createElement("div", { style: { height: "24px", width: "24px", color: n2.colorPrimary } }, t), !e2 && import_react94.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, r)));
}, "ThemedTitle");
...
var Rt = o2(({ Title: e2, render: t, meta: r, fixed: s, activeItemDisabled: n2 = false }) => {
  var Y2;
  let { token: i } = theme_default.useToken(), { siderCollapsed: a, setSiderCollapsed: l, mobileSiderOpen: u, setMobileSiderOpen: y } = fo(), p = mo(), f = (Y2 = (0, import_react96.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : Y2.direction, d = se(), g = yt(), { warnWhen: T, setWarnWhen: m } = vt(), { Link: b } = le(), x = d === "legacy" ? b : g, C = da(), v = $(), { menuItems: P, selectedKey: F, defaultOpenKeys: B } = Qu({ meta: r }), L = grid_default.useBreakpoint(), { hasDashboard: D } = ge(), c = ie(), { mutate: S2 } = Lr({ v3LegacyAuthProviderCompatible: !!(c != null && c.isLegacy) }), H = typeof L.lg > "u" ? false : !L.lg, U = e2 ?? C ?? be, j = o2((N, z) => N.map((E) => {
    let { icon: R, label: J, route: X, key: se2, name: _, children: fe, parentName: Z, meta: ee, options: le2 } = E;
    if (fe.length > 0) return import_react96.default.createElement(xc, { key: E.key, resource: _, action: "list", params: { resource: E } }, import_react96.default.createElement(menu_default.SubMenu, { key: E.key, icon: R ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: J }, j(fe, z)));
    let ie2 = se2 === z, de = !(S(ee == null ? void 0 : ee.parent, le2 == null ? void 0 : le2.parent, Z) !== void 0 && fe.length === 0), te = n2 && ie2 ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(xc, { key: E.key, resource: _, action: "list", params: { resource: E } }, import_react96.default.createElement(menu_default.Item, { key: E.key, icon: R ?? (de && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: te }, import_react96.default.createElement(x, { to: X ?? "", style: te }, J), !a && ie2 && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), h = o2(() => {
    T ? window.confirm(v("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (m(false), S2()) : S2();
  }, "handleLogout"), K = p && import_react96.default.createElement(menu_default.Item, { key: "logout", onClick: () => h(), icon: import_react96.default.createElement(LogoutOutlined_default, null) }, v("buttons.logout", "Logout")), $2 = D ? import_react96.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react96.default.createElement(DashboardOutlined_default, null) }, import_react96.default.createElement(x, { to: "/" }, v("dashboard.title", "Dashboard")), !a && F === "/" && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, A = j(P, F), w = o2(() => t ? t({ dashboard: $2, items: A, logout: K, collapsed: a }) : import_react96.default.createElement(import_react96.default.Fragment, null, $2, A, K), "renderSider"), q = o2(() => import_react96.default.createElement(menu_default, { selectedKeys: F ? [F] : [], defaultOpenKeys: B, mode: "inline", style: { paddingTop: "8px", border: "none", overflow: "auto", height: "calc(100% - 72px)" }, onClick: () => {
    y(false);
  } }, w()), "renderMenu"), k = o2(() => import_react96.default.createElement(import_react96.default.Fragment, null, import_react96.default.createElement(drawer_default, { open: u, onClose: () => y(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react96.default.createElement(layout_default, null, import_react96.default.createElement(layout_default.Sider, { style: { height: "100vh", backgroundColor: i.colorBgContainer, borderRight: `1px solid ${i.colorBgElevated}` } }, import_react96.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated } }, import_react96.default.createElement(U, { collapsed: false })), q()))), import_react96.default.createElement(button_default, { style: vo, size: "large", onClick: () => y(true), icon: import_react96.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
  if (H) return k();
  ...
  let M = o2(() => {
    ...
    return import_react96.default.createElement(a ? f === "rtl" ? LeftOutlined_default : RightOutlined_default : f === "rtl" ? RightOutlined_default : LeftOutlined_default, { ...N });
  }, "renderClosingIcons");
  return import_react96.default.createElement(import_react96.default.Fragment, null, s && import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", transition: "all 0.2s" } }), import_react96.default.createElement(layout_default.Sider, { style: O, collapsible: true, collapsed: a, onCollapse: (N, z) => {
    z === "clickTrigger" && l(N);
  }, collapsedWidth: 80, breakpoint: "lg", trigger: import_react96.default.createElement(button_default, { type: "text", style: { borderRadius: 0, height: "100%", width: "100%", backgroundColor: i.colorBgElevated } }, M()) }, import_react96.default.createElement("div", { style: { width: a ? "80px" : "200px", padding: a ? "0" : "0 16px", display: "flex", justifyContent: a ? "center" : "flex-start", alignItems: "center", height: "64px", backgroundColor: i.colorBgElevated, fontSize: "14px" } }, import_react96.default.createElement(U, { collapsed: a })), q()));
}, "ThemedSiderV2");
var It = o2(({ isSticky: e2, sticky: t }) => {
  ...
  return S(t, e2) && (a.position = "sticky", a.top = 0, a.zIndex = 1), import_react97.default.createElement(layout_default.Header, { style: a }, import_react97.default.createElement(space_default, null, import_react97.default.createElement(space_default, { size: "middle" }, (n2 == null ? void 0 : n2.name) && import_react97.default.createElement(typography_default.Text, { strong: true }, n2.name), (n2 == null ? void 0 : n2.avatar) && import_react97.default.createElement(avatar_default, { src: n2 == null ? void 0 : n2.avatar, alt: n2 == null ? void 0 : n2.name }))));
}, "ThemedHeaderV2");
var ra = o2(({ children: e2, Header: t, Sider: r, Title: s, Footer: n2, OffLayoutArea: i, initialSiderCollapsed: a }) => {
  ...
  return import_react95.default.createElement(ht, { initialSiderCollapsed: a }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: f }, import_react95.default.createElement(u, { Title: s }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(y, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: p ? 24 : 12 } }, e2), i && import_react95.default.createElement(i, null)), n2 && import_react95.default.createElement(n2, null))));
}, "ThemedLayoutV2");
var be = o2(({ collapsed: e2, icon: t, text: r, wrapperStyles: s }) => {
  ...
  return import_react98.default.createElement(y === "legacy" ? f : p, { to: "/", style: { display: "inline-block", textDecoration: "none" } }, import_react98.default.createElement(space_default, { style: { display: "flex", alignItems: "center", fontSize: "inherit", ...s } }, import_react98.default.createElement("div", { style: { height: "24px", width: "24px", color: u.colorPrimary } }, a), !e2 && import_react98.default.createElement(typography_default.Title, { style: { fontSize: "inherit", marginBottom: 0, fontWeight: 700 } }, l)));
}, "ThemedTitleV2");
var Ut = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...l }) => {
  ...
  return u ? null : import_react99.default.createElement(d, { to: g, replace: false, onClick: (T) => {
    if (y) {
      T.preventDefault();
      return;
    }
    a && (T.preventDefault(), a(T));
  } }, import_react99.default.createElement(button_default, { icon: import_react99.default.createElement(PlusSquareOutlined_default, null), disabled: y, title: f, className: n.CreateButton, type: "primary", ...l }, !r && (i ?? p)));
}, "CreateButton");
var Ot = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  ...
  return d ? null : import_react100.default.createElement(T, { to: y, replace: false, onClick: (m) => {
    if (g) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react100.default.createElement(button_default, { icon: import_react100.default.createElement(EditOutlined_default, null), disabled: g, title: f, className: n.EditButton, ...u }, !s && (a ?? p)));
}, "EditButton");
var Ye = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, onSuccess: s, mutationMode: n2, children: i, successNotification: a, errorNotification: l, hideText: u = false, accessControl: y, metaData: p, meta: f, dataProviderName: d, confirmTitle: g, confirmOkText: T, confirmCancelText: m, invalidates: b, ...x }) => {
  ...
  return P ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: T ?? D, cancelText: m ?? c, okType: "danger", title: g ?? L, okButtonProps: { disabled: B }, onConfirm: S2, disabled: typeof (x == null ? void 0 : x.disabled) < "u" ? x.disabled : F }, import_react101.default.createElement(button_default, { danger: true, loading: B, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: C, disabled: F, className: n.DeleteButton, ...x }, !u && (i ?? v)));
}, "DeleteButton");
var _e2 = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, dataProviderName: n2, children: i, meta: a, metaData: l, ...u }) => {
  ...
  return import_react102.default.createElement(button_default, { onClick: y, icon: import_react102.default.createElement(RedoOutlined_default, { spin: f }), className: n.RefreshButton, ...u }, !s && (i ?? p));
}, "RefreshButton");
var Ha = o2(({ resource: e2, resourceNameOrRouteName: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  ...
  return d ? null : import_react103.default.createElement(T, { to: y, replace: false, onClick: (m) => {
    if (g) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: g, title: f, className: n.ShowButton, ...u }, !s && (a ?? p)));
}, "ShowButton");
var Ze = o2(({ resource: e2, resourceNameOrRouteName: t, hideText: r = false, accessControl: s, meta: n2, children: i, onClick: a, ...l }) => {
  ...
  return f ? null : import_react104.default.createElement(g, { to: u, replace: false, onClick: (T) => {
    if (d) {
      T.preventDefault();
      return;
    }
    a && (T.preventDefault(), a(T));
  } }, import_react104.default.createElement(button_default, { icon: import_react104.default.createElement(BarsOutlined_default, null), disabled: d, title: p, className: n.ListButton, ...l }, !r && (i ?? y)));
}, "ListButton");
var $a = o2(({ hideText: e2 = false, children: t, ...r }) => {
  let { label: s } = Sv();
  return import_react105.default.createElement(button_default, { type: "default", icon: import_react105.default.createElement(ExportOutlined_default, null), className: n.ExportButton, ...r }, !e2 && (t ?? s));
}, "ExportButton");
var Xe = o2(({ hideText: e2 = false, children: t, ...r }) => {
  let { label: s } = Iv();
  return import_react106.default.createElement(button_default, { type: "primary", icon: import_react106.default.createElement(SaveOutlined_default, null), className: n.SaveButton, ...r }, !e2 && (t ?? s));
}, "SaveButton");
var ni = o2(({ resourceNameOrRouteName: e2, resource: t, recordItemId: r, hideText: s = false, accessControl: n2, meta: i, children: a, onClick: l, ...u }) => {
  ...
  return g ? null : import_react107.default.createElement(p, { to: y, replace: false, onClick: (m) => {
    if (d) {
      m.preventDefault();
      return;
    }
    l && (m.preventDefault(), l(m));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: d, title: T, className: n.CloneButton, ...u }, !s && (a ?? f)));
}, "CloneButton");
var mi = o2(({ uploadProps: e2, buttonProps: t, hideText: r = false, children: s, loading: n2 }) => {
  let { label: i } = Av();
  return import_react108.default.createElement(upload_default, { ...e2 }, import_react108.default.createElement(button_default, { icon: import_react108.default.createElement(ImportOutlined_default, null), className: n.ImportButton, loading: n2, ...t }, !r && (s ?? i)));
}, "ImportButton");
var hi = o2(({ canCreate: e2, title: t, children: r, createButtonProps: s, resource: n2, wrapperProps: i, contentProps: a, headerProps: l, breadcrumb: u, headerButtonProps: y, headerButtons: p }) => {
  var F, B;
  let f = $(), { options: { breadcrumb: d } = {} } = ge(), g = se(), T = Pt(), { resource: m, identifier: b } = Y(n2), x = e2 ?? (((m == null ? void 0 : m.canCreate) ?? !!(m != null && m.create)) || s), C = typeof u > "u" ? d : u, v = x ? { size: "middle", resource: g === "legacy" ? m == null ? void 0 : m.route : b, ...s } : void 0, P = x ? import_react109.default.createElement(Ut, { ...v }) : null;
  return import_react109.default.createElement("div", { ...i ?? {} }, import_react109.default.createElement(ke, { ghost: false, title: t ?? f(`${b}.titles.list`, T(((F = m == null ? void 0 : m.meta) == null ? void 0 : F.label) ?? ((B = m == null ? void 0 : m.options) == null ? void 0 : B.label) ?? (m == null ? void 0 : m.label) ?? b, "plural")), extra: p ? import_react109.default.createElement(space_default, { wrap: true, ...y }, typeof p == "function" ? p({ defaultButtons: P, createButtonProps: v }) : p) : P, breadcrumb: typeof C < "u" ? import_react109.default.createElement(import_react109.default.Fragment, null, C) ?? void 0 : import_react109.default.createElement(Le2, null), ...l ?? {} }, import_react109.default.createElement("div", { ...a ?? {} }, r)));
}, "List");
var Di = o2(({ title: e2, saveButtonProps: t, children: r, resource: s, isLoading: n2 = false, breadcrumb: i, wrapperProps: a, headerProps: l, contentProps: u, headerButtonProps: y, headerButtons: p, footerButtonProps: f, footerButtons: d, goBack: g }) => {
  var S2, H;
  let T = $(), { options: { breadcrumb: m } = {} } = ge(), b = se(), x = Eo(), { goBack: C } = Pe(), v = Pt(), { resource: P, action: F, identifier: B } = Y(s), L = typeof i > "u" ? m : i, D = { ...n2 ? { disabled: true } : {}, ...t, htmlType: "submit" }, c = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...D }));
  return import_react110.default.createElement("div", { ...a ?? {} }, import_react110.default.createElement(ke, { ghost: false, backIcon: g, onBack: F !== "list" || typeof F < "u" ? b === "legacy" ? C : x : void 0, title: e2 ?? T(`${B}.titles.create`, `Create ${v(((S2 = P == null ? void 0 : P.meta) == null ? void 0 : S2.label) ?? ((H = P == null ? void 0 : P.options) == null ? void 0 : H.label) ?? (P == null ? void 0 : P.label) ?? B, "singular")}`), breadcrumb: typeof L < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, L) ?? void 0 : import_react110.default.createElement(Le2, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: null }) : p : null), ...l ?? {} }, import_react110.default.createElement(spin_default, { spinning: n2 }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...f ?? {} }, d ? typeof d == "function" ? d({ defaultButtons: c, saveButtonProps: D }) : d : c)], ...u ?? {} }, r))));
}, "Create");
var zi = o2(({ title: e2, saveButtonProps: t, mutationMode: r, recordItemId: s, children: n2, deleteButtonProps: i, canDelete: a, resource: l, isLoading: u = false, dataProviderName: y, breadcrumb: p, wrapperProps: f, headerProps: d, contentProps: g, headerButtonProps: T, headerButtons: m, footerButtonProps: b, footerButtons: x, goBack: C, autoSaveProps: v }) => {
  ...
  }, recordItemId: q, dataProviderName: y, ...i } : void 0, E = { ...u ? { disabled: true } : {}, ...t }, R = import_react111.default.createElement(import_react111.default.Fragment, null, v && import_react111.default.createElement(Oo, { ...v }), O && import_react111.default.createElement(Ze, { ...Y2 }), import_react111.default.createElement(_e2, { ...N })), J = import_react111.default.createElement(import_react111.default.Fragment, null, M && import_react111.default.createElement(Ye, { ...z }), import_react111.default.createElement(Xe, { ...E }));
  return import_react111.default.createElement("div", { ...f ?? {} }, import_react111.default.createElement(ke, { ghost: false, backIcon: C, onBack: K !== "list" && typeof K < "u" ? D === "legacy" ? H : c : void 0, title: e2 ?? P(`${A}.titles.edit`, `Edit ${j(((se2 = h == null ? void 0 : h.meta) == null ? void 0 : se2.label) ?? ((_ = h == null ? void 0 : h.options) == null ? void 0 : _.label) ?? (h == null ? void 0 : h.label) ?? A, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...T ?? {} }, m ? typeof m == "function" ? m({ defaultButtons: R, listButtonProps: Y2, refreshButtonProps: N }) : m : R), breadcrumb: typeof k < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, k) ?? void 0 : import_react111.default.createElement(Le2, null), ...d ?? {} }, import_react111.default.createElement(spin_default, { spinning: u }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...b ?? {} }, x ? typeof x == "function" ? x({ defaultButtons: J, deleteButtonProps: z, saveButtonProps: E }) : x : J)], ...g ?? {} }, n2))));
}, "Edit");
var ep = o2(({ title: e2, canEdit: t, canDelete: r, isLoading: s = false, children: n2, resource: i, recordItemId: a, dataProviderName: l, breadcrumb: u, contentProps: y, headerProps: p, wrapperProps: f, headerButtons: d, footerButtons: g, footerButtonProps: T, headerButtonProps: m, goBack: b }) => {
  ...
  }, dataProviderName: l } : void 0, M = { ...s ? { disabled: true } : {}, resource: v === "legacy" ? c == null ? void 0 : c.route : U, recordItemId: h, dataProviderName: l }, Y2 = import_react112.default.createElement(import_react112.default.Fragment, null, $2 && import_react112.default.createElement(Ze, { ...q }), w && import_react112.default.createElement(Ot, { ...k }), A && import_react112.default.createElement(Ye, { ...O }), import_react112.default.createElement(_e2, { ...M }));
  return import_react112.default.createElement("div", { ...f ?? {} }, import_react112.default.createElement(ke, { ghost: false, backIcon: b, onBack: S2 !== "list" && typeof S2 < "u" ? v === "legacy" ? B : P : void 0, title: e2 ?? x(`${U}.titles.show`, `Show ${D(((z = c == null ? void 0 : c.meta) == null ? void 0 : z.label) ?? ((E = c == null ? void 0 : c.options) == null ? void 0 : E.label) ?? (c == null ? void 0 : c.label) ?? U, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...m ?? {} }, d ? typeof d == "function" ? d({ defaultButtons: Y2, deleteButtonProps: O, editButtonProps: k, listButtonProps: q, refreshButtonProps: M }) : d : Y2), breadcrumb: typeof K < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, K) ?? void 0 : import_react112.default.createElement(Le2, null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: s }, import_react112.default.createElement(card_default, { bordered: false, actions: g ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...T }, typeof g == "function" ? g({ defaultButtons: null }) : g)] : void 0, ...y ?? {} }, n2))));
}, "Show");
var rp = o2(({ value: e2, ...t }) => import_react113.default.createElement(typography_default.Text, { ...t }, e2), "TextField");
var ap = o2(({ value: e2, ...t }) => import_react114.default.createElement(tag_default, { ...t }, e2 == null ? void 0 : e2.toString()), "TagField");
var lp = o2(({ value: e2, ...t }) => import_react115.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...t }, e2), "EmailField");
var mp = o2(({ value: e2, imageTitle: t, ...r }) => import_react116.default.createElement(image_default, { ...r, src: e2, title: t }), "ImageField");
var gp = o2(({ value: e2, valueLabelTrue: t = "true", valueLabelFalse: r = "false", trueIcon: s = import_react117.default.createElement(CheckOutlined_default, null), falseIcon: n2 = import_react117.default.createElement(CloseOutlined_default, null), ...i }) => import_react117.default.createElement(tooltip_default, { title: e2 ? t : r, ...i }, e2 ? import_react117.default.createElement("span", null, s) : import_react117.default.createElement("span", null, n2)), "BooleanField");
var xp = o2(({ value: e2, locales: t, format: r = "L", ...s }) => {
  ...
  return import_react118.default.createElement(typography_default.Text, { ...s }, e2 ? (0, import_dayjs5.default)(e2).locale(t || n2).format(r) : "");
}, "DateField");
var Cp = o2(({ title: e2, src: t, ...r }) => import_react119.default.createElement(qt, { value: t, title: e2, ...r }, e2 ?? t), "FileField");
var qt = o2(({ children: e2, value: t, ...r }) => import_react120.default.createElement(typography_default.Link, { href: t, ...r }, e2 ?? t), "UrlField");
function Lp() {
...
var kp = o2(({ value: e2, locale: t, options: r, ...s }) => {
  let n2 = Number(e2);
  return import_react121.default.createElement(typography_default.Text, { ...s }, Lp() ? n2.toLocaleString(t, r) : n2);
}, "NumberField");
var Rp = o2(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var Up = o2((e2) => {
  let { setSelectedKeys: t, confirm: r, clearFilters: s, mapValue: n2 = o2((d) => d, "mapValue"), selectedKeys: i, children: a } = e2, l = $(), u = o2(() => {
    ...
    let g = n2(d, "onChange");
    t(g);
  }, "onChange"), f = import_react123.default.Children.map(a, (d) => import_react123.default.isValidElement(d) ? import_react123.default.cloneElement(d, { onChange: p, value: n2(i, "value") }) : d);
  return import_react123.default.createElement("div", { style: { padding: 10, display: "flex", flexDirection: "column", alignItems: "flex-end" } }, import_react123.default.createElement("div", { style: { marginBottom: 15 } }, f), import_react123.default.createElement(space_default, null, import_react123.default.createElement(button_default, { type: "primary", size: "small", onClick: () => y() }, import_react123.default.createElement(FilterOutlined_default, null), " ", l("buttons.filter", "Filter")), import_react123.default.createElement(button_default, { danger: true, size: "small", onClick: () => u() }, l("buttons.clear", "Clear"))));
}, "FilterDropdown");
var Yp = o2(() => {
  let [e2, t] = (0, import_react124.useState)(), r = $(), { push: s } = Pe(), n2 = Le(), i = se(), { resource: a, action: l } = Y();
  ...
  }, [a, l]), import_react124.default.createElement(result_default, { status: "404", title: "404", extra: import_react124.default.createElement(space_default, { direction: "vertical", size: "large" }, import_react124.default.createElement(space_default, null, import_react124.default.createElement(typography_default.Text, null, r("pages.error.404", "Sorry, the page you visited does not exist.")), e2 && import_react124.default.createElement(tooltip_default, { title: e2 }, import_react124.default.createElement(InfoCircleOutlined_default, {}))), import_react124.default.createElement(button_default, { type: "primary", onClick: () => {
    i === "legacy" ? s("/") : n2({ to: "/" });
...
var nl = o2(() => {
  let [e2] = form_default.useForm(), t = $(), r = ie(), { mutate: s, isLoading: n2 } = $t({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) }), i = import_react125.default.createElement(typography_default.Title, { level: 3, style: qo2 }, t("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: jo }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Wo }, import_react125.default.createElement("div", { style: Go }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: i, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (a) => {
    s(a);
  }, requiredMark: false, initialValues: { remember: false } }, import_react125.default.createElement(form_default.Item, { name: "username", label: t("pages.login.username", "Username"), rules: [{ required: true }] }, import_react125.default.createElement(input_default, { size: "large", placeholder: t("pages.login.username", "Username") })), import_react125.default.createElement(form_default.Item, { name: "password", label: t("pages.login.password", "Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react125.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react125.default.createElement("div", { style: { marginBottom: "12px" } }, import_react125.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react125.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, t("pages.login.remember", "Remember me"))), import_react125.default.createElement("a", { style: { float: "right", fontSize: "12px" }, href: "#" }, t("pages.login.forgotPassword", "Forgot password?"))), import_react125.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: n2, block: true }, t("pages.login.signin", "Sign in"))), import_react125.default.createElement("div", { style: { marginTop: 8 } }, import_react125.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, t("pages.login.noAccount", "Don’t have an account?"), " ", import_react125.default.createElement("a", { href: "#", style: { fontWeight: "bold" } }, t("pages.login.signup", "Sign up")))))))));
}, "LoginPage");
...
var gl = o2(() => import_react126.default.createElement(qu, null), "WelcomePage");
var De = {};
...
var $t2 = o2(({ providers: e2, registerLink: t, forgotPasswordLink: r, rememberMe: s, contentProps: n2, wrapperProps: i, renderContent: a, formProps: l, title: u, hideForm: y }) => {
  let { token: p } = theme_default.useToken(), [f] = form_default.useForm(), d = $(), g = se(), T = yt(), { Link: m } = le(), b = g === "legacy" ? m : T, x = ie(), { mutate: C, isLoading: v } = $t({ v3LegacyAuthProviderCompatible: !!(x != null && x.isLegacy) }), P = u === false ? null : import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, u ?? import_react128.default.createElement(be, { collapsed: false })), F = import_react128.default.createElement(typography_default.Title, { level: 3, style: { color: p.colorPrimaryTextHover, ...Ie } }, d("pages.login.title", "Sign in to your account")), B = o2(() => e2 && e2.length > 0 ? import_react128.default.createElement(import_react128.default.Fragment, null, e2.map((D) => import_react128.default.createElement(button_default, { key: D.name, type: "default", block: true, icon: D.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => C({ providerName: D.name }) }, D.label)), !y && import_react128.default.createElement(divider_default, null, import_react128.default.createElement(typography_default.Text, { style: { color: p.colorTextLabel } }, d("pages.login.divider", "or")))) : null, "renderProviders"), L = import_react128.default.createElement(card_default, { title: F, headStyle: Ee, bodyStyle: Re, style: { ...we, backgroundColor: p.colorBgElevated }, ...n2 ?? {} }, B(), !y && import_react128.default.createElement(form_default, { layout: "vertical", form: f, onFinish: (D) => C(D), requiredMark: false, initialValues: { remember: false }, ...l }, import_react128.default.createElement(form_default.Item, { name: "email", label: d("pages.login.fields.email", "Email"), rules: [{ required: true, message: d("pages.login.errors.requiredEmail", "Email is required") }, { type: "email", message: d("pages.login.errors.validEmail", "Invalid email address") }] }, import_react128.default.createElement(input_default, { size: "large", placeholder: d("pages.login.fields.email", "Email") })), import_react128.default.createElement(form_default.Item, { name: "password", label: d("pages.login.fields.password", "Password"), rules: [{ required: true, message: d("pages.login.errors.requiredPassword", "Password is required") }] }, import_react128.default.createElement(input_default, { type: "password", autoComplete: "current-password", placeholder: "●●●●●●●●", size: "large" })), import_react128.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, s ?? import_react128.default.createElement(form_default.Item, { name: "remember", valuePropName: "checked", noStyle: true }, import_react128.default.createElement(checkbox_default, { style: { fontSize: "12px" } }, d("pages.login.buttons.rememberMe", "Remember me"))), r ?? import_react128.default.createElement(b, { style: { color: p.colorPrimaryTextHover, fontSize: "12px", marginLeft: "auto" }, to: "/forgot-password" }, d("pages.login.buttons.forgotPassword", "Forgot password?"))), !y && import_react128.default.createElement(form_default.Item, null, import_react128.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: v, block: true }, d("pages.login.signin", "Sign in")))), t ?? import_react128.default.createElement("div", { style: { marginTop: y ? 16 : 8 } }, import_react128.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, d("pages.login.buttons.noAccount", "Don’t have an account?"), " ", import_react128.default.createElement(b, { to: "/register", style: { fontWeight: "bold", color: p.colorPrimaryTextHover } }, d("pages.login.signup", "Sign up")))));
  return import_react128.default.createElement(layout_default, { style: De, ...i ?? {} }, import_react128.default.createElement(row_default, { justify: "center", align: y ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: y ? "15dvh" : "16px" } }, import_react128.default.createElement(col_default, { xs: 22 }, a ? a(L, P) : import_react128.default.createElement(import_react128.default.Fragment, null, P, L))));
}, "LoginPage");
var Yt = o2(({ providers: e2, loginLink: t, wrapperProps: r, contentProps: s, renderContent: n2, formProps: i, title: a, hideForm: l }) => {
  let { token: u } = theme_default.useToken(), [y] = form_default.useForm(), p = $(), f = se(), d = yt(), { Link: g } = le(), T = f === "legacy" ? g : d, m = ie(), { mutate: b, isLoading: x } = io({ v3LegacyAuthProviderCompatible: !!(m != null && m.isLegacy) }), C = a === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, a ?? import_react129.default.createElement(be, { collapsed: false })), v = import_react129.default.createElement(typography_default.Title, { level: 3, style: { color: u.colorPrimaryTextHover, ...Ie } }, p("pages.register.title", "Sign up for your account")), P = o2(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((B) => import_react129.default.createElement(button_default, { key: B.name, type: "default", block: true, icon: B.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => b({ providerName: B.name }) }, B.label)), !l && import_react129.default.createElement(divider_default, null, import_react129.default.createElement(typography_default.Text, { style: { color: u.colorTextLabel } }, p("pages.register.divider", p("pages.login.divider", "or"))))) : null, "renderProviders"), F = import_react129.default.createElement(card_default, { title: v, headStyle: Ee, bodyStyle: Re, style: { ...we, backgroundColor: u.colorBgElevated }, ...s ?? {} }, P(), !l && import_react129.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (B) => b(B), requiredMark: false, ...i }, import_react129.default.createElement(form_default.Item, { name: "email", label: p("pages.register.email", "Email"), rules: [{ required: true, message: p("pages.register.errors.requiredEmail", "Email is required") }, { type: "email", message: p("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: p("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: p("pages.register.fields.password", "Password"), rules: [{ required: true, message: p("pages.register.errors.requiredPassword", "Password is required") }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, t ?? import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, p("pages.register.buttons.haveAccount", p("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react129.default.createElement(T, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, p("pages.register.signin", p("pages.login.signin", "Sign in"))))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: x, block: true }, p("pages.register.buttons.submit", "Sign up")))), l && t !== false && import_react129.default.createElement("div", { style: { marginTop: l ? 16 : 8 } }, import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, p("pages.register.buttons.haveAccount", p("pages.login.buttons.haveAccount", "Have an account?")), " ", import_react129.default.createElement(T, { style: { fontWeight: "bold", color: u.colorPrimaryTextHover }, to: "/login" }, p("pages.register.signin", p("pages.login.signin", "Sign in"))))));
  return import_react129.default.createElement(layout_default, { style: De, ...r ?? {} }, import_react129.default.createElement(row_default, { justify: "center", align: l ? "top" : "middle", style: { padding: "16px 0", minHeight: "100dvh", paddingTop: l ? "15dvh" : "16px" } }, import_react129.default.createElement(col_default, { xs: 22 }, n2 ? n2(F, C) : import_react129.default.createElement(import_react129.default.Fragment, null, C, F))));
}, "RegisterPage");
var _t = o2(({ loginLink: e2, wrapperProps: t, contentProps: r, renderContent: s, formProps: n2, title: i }) => {
  let { token: a } = theme_default.useToken(), [l] = form_default.useForm(), u = $(), y = se(), p = yt(), { Link: f } = le(), d = y === "legacy" ? f : p, { mutate: g, isLoading: T } = co(), m = i === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react130.default.createElement(be, { collapsed: false })), b = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: a.colorPrimaryTextHover, ...Ie } }, u("pages.forgotPassword.title", "Forgot your password?")), x = import_react130.default.createElement(card_default, { title: b, headStyle: Ee, bodyStyle: Re, style: { ...we, backgroundColor: a.colorBgElevated }, ...r ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: l, onFinish: (C) => g(C), requiredMark: false, ...n2 }, import_react130.default.createElement(form_default.Item, { name: "email", label: u("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true, message: u("pages.forgotPassword.errors.requiredEmail", "Email is required") }, { type: "email", message: u("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: u("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, u("pages.forgotPassword.buttons.haveAccount", u("pages.register.buttons.haveAccount", "Have an account? ")), " ", import_react130.default.createElement(d, { style: { fontWeight: "bold", color: a.colorPrimaryTextHover }, to: "/login" }, u("pages.forgotPassword.signin", u("pages.login.signin", "Sign in"))))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: T, block: true }, u("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: De, ...t ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react130.default.createElement(col_default, { xs: 22 }, s ? s(x, m) : import_react130.default.createElement(import_react130.default.Fragment, null, m, x))));
}, "ForgotPasswordPage");
var Zt = o2(({ wrapperProps: e2, contentProps: t, renderContent: r, formProps: s, title: n2 }) => {
  let { token: i } = theme_default.useToken(), [a] = form_default.useForm(), l = $(), u = ie(), { mutate: y, isLoading: p } = lo({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), f = n2 === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, n2 ?? import_react131.default.createElement(be, { collapsed: false })), d = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: i.colorPrimaryTextHover, ...Ie } }, l("pages.updatePassword.title", "Set New Password")), g = import_react131.default.createElement(card_default, { title: d, headStyle: Ee, bodyStyle: Re, style: { ...we, backgroundColor: i.colorBgElevated }, ...t ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: a, onFinish: (T) => y(T), requiredMark: false, ...s }, import_react131.default.createElement(form_default.Item, { name: "password", label: l("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true, message: l("pages.updatePassword.errors.requiredPassword", "Password is required") }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: l("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true, message: l("pages.updatePassword.errors.requiredConfirmPassword", "Confirm password is required") }, ({ getFieldValue: T }) => ({ validator(m, b) {
  ...
  } })] }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react131.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: p, block: true }, l("pages.updatePassword.buttons.submit", "Update")))));
  return import_react131.default.createElement(layout_default, { style: De, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, r ? r(g, f) : import_react131.default.createElement(import_react131.default.Fragment, null, f, g))));
}, "UpdatePasswordPage");
var dd = o2((e2) => {
  let { type: t } = e2;
  return import_react127.default.createElement(import_react127.default.Fragment, null, o2(() => {
    switch (t) {
      case "register":
        return import_react127.default.createElement(Yt, { ...e2 });
      case "forgotPassword":
        return import_react127.default.createElement(_t, { ...e2 });
      case "updatePassword":
        return import_react127.default.createElement(Zt, { ...e2 });
      default:
        return import_react127.default.createElement($t2, { ...e2 });
    }
  }, "renderView")());
}, "AuthPage");
var Le2 = o2(({ breadcrumbProps: e2, showHome: t = true, hideIcons: r = false, meta: s }) => {
  ...
  let d = i.map(({ label: T, icon: m, href: b }) => ({ key: `breadcrumb-item-${T}`, title: import_react132.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 4 } }, !r && m, b ? import_react132.default.createElement(f, { to: b }, T) : import_react132.default.createElement("span", null, T)) }));
  return import_react132.default.createElement(breadcrumb_default, { items: o2(() => {
    var T, m;
    return t && (u || p.found) ? [{ key: "breadcrumb-item-home", title: import_react132.default.createElement(f, { to: "/" }, ((m = (T = p == null ? void 0 : p.resource) == null ? void 0 : T.meta) == null ? void 0 : m.icon) ?? import_react132.default.createElement(HomeOutlined_default, null)) }, ...d] : d;
  }, "getBreadcrumbItems")(), ...e2 });
}, "Breadcrumb");
var ke = o2(({ children: e2, ...t }) => {
  var l;
  let r = (l = (0, import_react133.useContext)(config_provider_default.ConfigContext)) == null ? void 0 : l.direction, s = o2(() => import_react133.default.createElement(button_default, { type: "text", icon: import_react133.default.createElement(r === "rtl" ? ArrowRightOutlined_default : ArrowLeftOutlined_default, null) }), "renderBackButton"), n2 = typeof t.backIcon > "u" ? s() : t.backIcon, i = typeof t.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.Title, level: 4, style: { marginBottom: 0 } }, t.title) : t.title, a = typeof t.title == "string" ? import_react133.default.createElement(typography_default.Title, { className: o.SubTitle, level: 5, type: "secondary", style: { marginBottom: 0 } }, t.subTitle) : t.subTitle;
  return import_react133.default.createElement(PageHeader, { ...t, backIcon: n2, title: i, subTitle: a, style: { padding: 0, ...t.style } }, e2);
}, "PageHeader");
var Oo = o2(({ status: e2, elements: { success: t = import_react134.default.createElement(ut, { translationKey: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: r = import_react134.default.createElement(ut, { translationKey: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: s = import_react134.default.createElement(ut, { translationKey: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: n2 = import_react134.default.createElement(ut, { translationKey: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(bc, { status: e2, elements: { success: t, error: r, loading: s, idle: n2 } }), "AutoSaveIndicator");
var ut = o2(({ translationKey: e2, defaultMessage: t, icon: r }) => {
  let s = $(), { token: n2 } = theme_default.useToken();
  return import_react134.default.createElement(typography_default.Text, { style: { marginRight: 5, color: n2.colorTextTertiary, fontSize: ".8rem" } }, s(e2, t), import_react134.default.createElement("span", { style: { marginLeft: ".2rem" } }, r));
}, "Message");
